...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inside', '0002_rename_publiched_bd_published'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='bd',
            name='rubric',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='inside.rubric', verbose_name='Рубрика'),
        ),
    ]
